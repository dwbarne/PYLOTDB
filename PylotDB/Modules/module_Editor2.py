...
# Globals
DEBUG_LINE_NUMBER_INDEX = 0     # set to 1 to print line number index;  0 to suppress output
DEBUG_PRINT_METHOD = 0          # set to 1 to print which method is being processed
MODULE = 'module_Editor2'
...
class Editor(Frame):
    ...
    def __init__(self,parentFrame0,parentFrame1,bgcolor,labelMain,titleFont,dataFont):
        """
...
#   current filename
        self.labelCurrentFilename = Label(
            self.frameEditor00,
            text='Current filename: ',
            bg=self.bgcolor,
            fg='black',
            )
        self.labelCurrentFilename.grid(
            row=2,
            column=0,
            padx=5,
            pady=5,
            )
        self.varPlotFileCurrentFilename=StringVar()
        self.varPlotFileCurrentFilename.set('None')
        self.entryCurrentFilename = Entry(
            self.frameEditor00,
            bg='white',
            fg='black',
            width=30,
            textvariable=self.varPlotFileCurrentFilename,
            )
        self.entryCurrentFilename.grid(
            row=2,
            column=1,
            padx=5,
            pady=5,
...
#        width=6,
            borderwidth=5,
            relief=RAISED,
            command=self.handlerTextBox_Search,
            )
...
# ... text box with numbers
        ...
        if DEBUG_LINE_NUMBER_INDEX:
            print()
            print(' ***** Line number index: %s' % self.textLineNumbers.index(INSERT))
            print(' ***** END index: %s' % self.textLineNumbers.index(END))
            print()
...
# ... couple scrollbars to text box
        ...
        self.yScrollMyCode.configure(
            command=self.handlerScrollTwoTextFrames,
            )
...
#        handlerTextLineNumbersReturn(self,' ')
            self.handlerTextLineNumbersReturn
            )
        self.textMyCode.bind(
            "<KeyPress-Up>",
            self.handlerTextLineNumbersUpArrow
            )
        self.textMyCode.bind(
            "<KeyPress-Down>",
            self.handlerTextLineNumbersDownArrow
            )
        self.textMyCode.bind(
            "<KeyPress-BackSpace>",
            self.handlerTextLineNumbersDelete
            )
        self.textMyCode.bind(
            "<Leave>",
            self.handlerTextLineNumbersHilite
            )
        self.textMyCode.bind(
            "<Enter>",
...
#    self.frameTextButtons,
            ...
            indicatoron=0,
            width=10,
            command=self.handlerCheckButtonWrap,
...
#        )
        ...
        self.buttonClear = Button(
            ...
            justify=CENTER,
            relief=RAISED,
            command=self.handlerClearTextField,
            )
...
# DWB - Move to column 1 when wrap/unwrap is restored
        ...
        self.buttonAddRemoveSpaces = Button(
            ...
            borderwidth=5,
            relief=RAISED,
            command=self.handlerPlusMinusLeadingSpaces,
            )
        ...
        self.buttonClearSelection = Button(
            ...
            justify=CENTER,
            relief=RAISED,
            command=self.handlerTextBox_ClearSelection,
            )
...
#        )
        ...
        self.buttonRefreshLineNumbers = Button(
            ...
            borderwidth=5,
            relief=RAISED,
            command=self.refreshLineNumbers,
            )
...
# button to execute python code
        ...
        buttonExecute = Button(
            ...
            borderwidth=5,
            relief=RAISED,
            command=self.handlerExecuteCode,
            )
        buttonExecute.grid(
            row=2,
            column=4,
...
#        def tempDef(event):
        ...
        if DEBUG_PRINT_METHOD:
            print('\n** In ' + MODULE + '/' + 'handlerTextLineNumbersReturn')
...
# ===== handlerTextLineNumbersUpArrow =====
    def handlerTextLineNumbersUpArrow(self,event):
        ...
        """
        if DEBUG_PRINT_METHOD:
            print('\n** In ' + MODULE + '/' + 'handlerSeeTextLineNumbersUpArrow')
...
#        def tempDef(event):
        ...
        if DEBUG_PRINT_METHOD:
            print('\n** In ' + MODULE + '/' + 'handlerSeeTextLineNumbersDownArrow')
...
# ===== handler TempDelete =====
    def handlerTempDelete(self):
        ...
        """
        if DEBUG_PRINT_METHOD:
            print('** In ' + MODULE + '/' + 'handlerTempDelete')
...
#        def tempDef(event):
        ...
        if DEBUG_PRINT_METHOD:
            print('\n** In ' + MODULE + '/' + 'handlerTextLineNumbersDelete')
...
# ===== handlerTextLineNumbersHilite =====
    def handlerTextLineNumbersHilite(self,event):
        ...
        """               
        if DEBUG_PRINT_METHOD:
            print('\n** In ' + MODULE + '/' + 'handlerTextLineNumbersHilite')
...
# ===== handlerTextLineNumbersUnhilite =====
    def handlerTextLineNumbersUnhilite(self,event):
        ...
        if DEBUG_PRINT_METHOD:
            print('\n** In ' + MODULE + '/' + 'handlerTextLineNumbersUnhilite')
...
# ===== handlerTextMyCodeTab =====
    def handlerTextMyCodeTab(self,event):
        ...
        if DEBUG_PRINT_METHOD:
            print('\n** In ' + MODULE + '/' + 'handlerTextMyCodeTab')
...
#        def tempDef():
        ...
        if DEBUG_PRINT_METHOD:
            print('\n** In ' + MODULE + '/' + 'handlerCheckButtonWrap')
...
# ===== handlerPlusMinusLeadingSpaces =====
    ...
    def handlerPlusMinusLeadingSpaces(self):
        ...
        if DEBUG_PRINT_METHOD:
            print('\n** In ' + MODULE + '/' + 'handlerPlusMinusLeadingSpaces')
        
#        def tempDef():
# destroy any old toplevel frames
        try:
            self.myFramePMLS.destroy()
            print '\nPrevious toplevel widget removed from screen.'
        except: 
            print '\nNo previous toplevel widget to remove from screen.'
        
        self.myFramePMLS = Toplevel(
            self.parentFrame0,
            background='lightgreen'
            )
        self.myFramePMLS.transient(self.parentFrame0)
        self.myFramePMLS.title('Add/Delete Leading Spaces')
        module_leadingSpaces.leadingSpaces(self,self.myFramePMLS)  
...
# ==== handlerReadCode =====
    ...
    def handlerReadCode(self):
        ...
        if DEBUG_PRINT_METHOD:
            print('\n** In ' + MODULE + '/' + 'handlerReadCode')
    
# define dictionary of options
        options = {}
        if self.labelMain == 'INPUT FILE':
            options = {
                'defaultextension' : '.config',
                'filetypes' : [('config','.config'),('All files','.*')],
                'initialdir' : currentDirectory,
                'initialfile' : '',
                'parent' : self.parentFrame0,
...
#    dirname, filename = os.path.split(askopenfilename(**options))
        ...
        baseFilenamePlot = os.path.basename(filename)
        self.varPlotFileCurrentFilename.set(baseFilenamePlot)
...
# ===== handlerTextBox_Search =====
    def handlerTextBox_Search(self):
        ...
        if DEBUG_PRINT_METHOD:
            print('\n** In ' + MODULE + '/' + 'handlerTextBox_Search')
...
# ===== handlerTextBox_ClearSelection =====
    def handlerTextBox_ClearSelection(self):
        ...
        if DEBUG_PRINT_METHOD:
            print('\n** In ' + MODULE + '/' + 'handlerTextBox_ClearSelection')
...
# ===== handlerClearTextField =====
    ...
    def handlerClearTextField(self):
        ...
        """
        if DEBUG_PRINT_METHOD:
            print('\n** In ' + MODULE + '/' + 'handlerClearTextField')
