...
--
-- Table structure for table `sample_table_data`
--

DROP TABLE IF EXISTS `sample_table_data`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
CREATE TABLE `sample_table_data` (
...
-- Dump completed on 2012-04-10 15:47:41
